...
export async function GET(req: Request) {
  try {
    ...
    const results = dbProducts.map((p: Product) => ({
      ...
      fullScopeLevel: p.fullScopeLevel ?? "N/A",
      fullScopeVersion: p.fullScopeVersion ?? "N/A",
      materialHealthLevel: p.materialHealthLevel ?? "N/A",
      materialHealthVersion: p.materialHealthVersion ?? "N/A",
      circularityLevel: p.circularityLevel ?? "N/A",
      circularityVersion: p.circularityVersion ?? "N/A",
      slug: p.slug,
